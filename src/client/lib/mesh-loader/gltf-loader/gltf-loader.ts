            ...
            for(let i = 0; i < storage.nodes.length; i++) {
                if(storage.nodes[i].mesh !== undefined) {
                    ...
                    */
                    ...
                    // Parse primitives
                    for(let j = 0; j < storage.meshes[storage.nodes[i].mesh].primitives.length; j++) {
                        let mesh: IMesh;
                        ...
                        ***************************************************
                        */
                        const verticesAccessor: GLTFAccessor = storage.accessors[storage.meshes[storage.nodes[i].mesh].primitives[j].attributes.POSITION];
                        ...
                        if(storage.meshes[storage.nodes[i].mesh].primitives[j].indices !== undefined) {
                            /*
                            ***************************************************
                            *               Access indices buffer             *
                            ***************************************************
                            */
                            const indicesAccessor: GLTFAccessor = storage.accessors[storage.meshes[storage.nodes[i].mesh].primitives[j].indices];
                        ...
                        */
                        ...
                        switch(storage.meshes[storage.nodes[i].mesh].primitives[j].mode) {
                            ...
                            default: {
                                ...
                                throw new Error(`Unsupported type "${type}" (${storage.meshes[storage.nodes[i].mesh].primitives[j].mode}) in GLTF model.`);
                            }
                        }
                        ...
                        if(storage.meshes[storage.nodes[i].mesh].primitives[j].attributes.NORMAL !== undefined) {
                            /*
                            ***************************************************
                            *               Access normals buffer             *
                            ***************************************************
                            */
                            const normalsAccessor = storage.accessors[storage.meshes[storage.nodes[i].mesh].primitives[j].attributes.NORMAL];
                        ...
                        if(storage.meshes[storage.nodes[i].mesh].primitives[j].attributes.TEXCOORD_0 !== undefined) {
                            /*
                            ***************************************************
                            *                 Access UVs buffer               *
                            ***************************************************
                            */
                            ...
                            const uvsAccessor = storage.accessors[storage.meshes[storage.nodes[i].mesh].primitives[j].attributes.TEXCOORD_0];
                        ...
                        */
                        ...
                        const GLTFMaterial = storage.materials[storage.meshes[storage.nodes[i].mesh].primitives[j].material || 0];
                    ...
                    if(storage.nodes[i].extensions) {
                        ...
                        */
                        if(storage.nodes[i].extensions.KHR_lights_punctual) {
                            ...
                            *****************************************
                            */
                            const light = storage.extensions.KHR_lights_punctual.lights[storage.nodes[i].extensions.KHR_lights_punctual.light];
                            let pos = storage.nodes[i].translation || [0, 0, 0];
                            
                            lights.push(new LightEntity({
