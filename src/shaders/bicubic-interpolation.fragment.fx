...
vec4 textureBicubic(sampler2D tex, vec2 texCoords, float lod){
...
vec4 textureBicubic2D(sampler2D tex, vec2 texCoords) {
...
// void main(void) {
//     gl_FragColor = textureBicubic(textureSampler, vUV, 0.0);
// }